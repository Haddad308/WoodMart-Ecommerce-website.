                ...
                <div className="col-5 w-49 p-0 rounded-3 overflow-hidden">
                    <Slider {...settings}>
                        <div className={`${styles.s1} overflow-hidden  rounded-3 text-white p-3 d-flex flex-column align-items-center`}>
                            ...
                            <img className='rounded-3' src={g6} width={"500px"} height={382} alt="phone" />
                        ...
                        <div className={`${styles.s2} rounded-3 text-white p-3 d-flex flex-column align-items-center`}>
                            ...
                            <p>Shop Great deals on MacBook, IPad, Iphone and more.</p>
                            <img className='rounded-3' src={apple} width={"700px"} height={382} alt="phone" />
                            <button className='btn btn-primary'> Order Now!</button>
                        </div>
                    </Slider>
                </div>
                <div className="col-5 w-49">
                    <div className="row rounded-3 text-white bg-success  position-relative p-0 mb-3">
